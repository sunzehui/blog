...
<video muted="muted" autoplay="autoplay" loop="loop" playsinline="" class="demo-video" style="width:100%"><source src="./在小程序中实现历史搜索记录/test.mp4" type="video/webm"> </video>
...
<video muted="muted" autoplay="autoplay" loop="loop" playsinline="" class="demo-video" style="width:100%"><source src="./在小程序中实现历史搜索记录/bug1.mp4" type="video/webm"> </video>
